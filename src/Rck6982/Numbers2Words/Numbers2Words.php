...
/**
 * Numbers2Words es una adaptación de la libreria Numbers_words
 *
 * 
 * Numbers_words
 * 
...
use Rck6982\Numbers2Words\Numbers2WordsException;

use Rck6982\Numbers2Words\Locale\en\US;
use Rck6982\Numbers2Words\Locale\es\AR;
...
class Numbers2Words
{
     ...
     *
     * @throws Numbers2WordsException When the class cannot be loaded
     */
    public static function loadLocale($locale, $requiredMethod)
    {
        ...
        if (!class_exists($classname)) {
            ...
            if (!class_exists($classname)) {
                throw new Numbers2WordsException(
